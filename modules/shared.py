...
parser.add_argument("--textual-inversion-templates-dir", type=str, default=os.path.join(script_path, 'templates/textual_inversion'), help="directory with textual inversion templates")
