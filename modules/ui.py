        ...
        with gr.Row().style(equal_height=False):
            with gr.Tabs(elem_id="train_tabs"):
                ...
                with gr.Tab(label="Train"):
                    ...
                    template_file = gr.Textbox(label='Prompt template file', value=os.path.join(script_path, "templates/textual_inversion", "style_filewords.txt"), elem_id="train_template_file")
